...
public class NetworkLauncher : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
    {
        if (player == runner.LocalPlayer)
        {
            ...
            runner.Spawn(players[CharacterSelectManager.CharacterIndex], Vector3.zero, quaternion.identity, player, (runner, o) =>
            {
                runner.SetPlayerObject(player, o);
            });

            NetworkEvent.OnEnterRoom?.Invoke();
        }
